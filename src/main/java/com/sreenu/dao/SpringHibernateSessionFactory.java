...
public class SpringHibernateSessionFactory implements CustomerAccountDetailsDAOI {
	...
	public static void main(String[] args) {
		...
		SpringHibernateSessionFactory custDAO = new SpringHibernateSessionFactory();
