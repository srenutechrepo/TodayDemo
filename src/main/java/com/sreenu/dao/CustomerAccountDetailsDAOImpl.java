...
public class CustomerAccountDetailsDAOImpl implements CustomerAccountDetailsDAOI {
	...
	public CustomerDetailsResponse getCustomerDetails(
		...
		// load details
        if(custDetailReq.getAccountType()!=null && 
        (custDetailReq.getAccountType().equalsIgnoreCase("LOAN") 
	...
	public static void main(String[] args) {
		...
		CustomerAccountDetailsDAOImpl custDAO = new CustomerAccountDetailsDAOImpl();
