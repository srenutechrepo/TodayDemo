...
public class SpringHibernateHibernateTemplate implements CustomerAccountDetailsDAOI {
	...
	public static void main(String[] args) {
		...
		SpringHibernateHibernateTemplate custDAO = new SpringHibernateHibernateTemplate();
